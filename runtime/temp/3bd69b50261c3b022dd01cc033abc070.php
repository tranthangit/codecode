<?php /*a:2:{s:74:"/www/wwwroot/194.233.81.202/application/admin/view/help/edit_home_msg.html";i:1640628670;s:60:"/www/wwwroot/194.233.81.202/application/admin/view/main.html";i:1615971252;}*/ ?>
<div class="layui-card layui-bg-gray"><style>        .layui-tab-card>.layui-tab-title .layui-this {
            background-color: #fff;
        }
    </style><!--<div class="layui-tab layui-tab-card" lay-allowClose="true" lay-filter="test1">--><!--<ul class="layui-tab-title">--><!--<li lay-id="/admin/users/index" class="layui-this">网站设置</li>--><!--<li lay-id="/admin/deal/order_list">用户基本管理</li>--><!--<li lay-id="222">权限分配</li>--><!--<li lay-id="222">全部历史商品管理文字长一点试试</li>--><!--<li lay-id="222">全部历史商品管理文字长一点试试</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--<li lay-id="222">订单管理</li>--><!--</ul>--><!--</div>--><?php if(!(empty($title) || (($title instanceof \think\Collection || $title instanceof \think\Paginator ) && $title->isEmpty()))): ?><div class="layui-card-header layui-anim layui-anim-fadein notselect"><span class="layui-icon layui-icon-next font-s10 color-desc margin-right-5"></span><?php echo htmlentities((isset($title) && ($title !== '')?$title:'')); ?><div class="pull-right"></div></div><?php endif; ?><div class="layui-card-body layui-anim layui-anim-upbit"><form onsubmit="return false;" id="GoodsForm" data-auto="true" method="post" class='layui-form layui-card' autocomplete="off"><div class="layui-card-body think-box-shadow padding-left-40"><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">类型</span><input name="title" required class="layui-input" value="<?php echo htmlentities($info['title']); ?>" readonly placeholder="请输入公告标题"><input type="hidden" name="id" value="<?php echo htmlentities($info['id']); ?>"><input type="hidden" name="_csrf_" value="<?php echo systoken('admin/help/edit_home_msg'); ?>"></label></div><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">日语标题</span><input name="jp_title" required class="layui-input" value="<?php echo htmlentities($info['jp_title']); ?>"  placeholder="请输入公告日语标题"></label></div><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">韩语标题</span><input name="kr_title" required class="layui-input" value="<?php echo htmlentities($info['kr_title']); ?>"  placeholder="请输入公告韩语标题"></label></div><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">英文标题</span><input name="en_title" required class="layui-input" value="<?php echo htmlentities($info['en_title']); ?>"  placeholder="请输入公告英文标题"></label></div><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">法文标题</span><input name="fr_title" required class="layui-input" value="<?php echo htmlentities($info['fr_title']); ?>"  placeholder="请输入公告法文标题"></label></div><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">西班牙标题</span><input name="es_title" required class="layui-input" value="<?php echo htmlentities($info['es_title']); ?>"  placeholder="请输入公告西班牙标题"></label></div><div class="layui-form-item layui-row layui-col-space15"><label class="layui-col-xs9 relative"><span class="color-green">葡萄牙标题</span><input name="pt_title" required class="layui-input" value="<?php echo htmlentities($info['pt_title']); ?>"  placeholder="请输入公告葡萄牙标题"></label></div><div class="layui-form-item block"><span class="label-required-prev color-green">公告内容</span><textarea name="content"><?php echo htmlentities($info['content']); ?></textarea></div><div class="layui-form-item block"><span class="label-required-prev color-green">日语公告内容</span><textarea name="jp_content"><?php echo htmlentities($info['jp_content']); ?></textarea></div><div class="layui-form-item block"><span class="label-required-prev color-green">韩语公告内容</span><textarea name="kr_content"><?php echo htmlentities($info['kr_content']); ?></textarea></div><div class="layui-form-item block"><span class="label-required-prev color-green">英文公告内容</span><textarea name="en_content"><?php echo htmlentities($info['en_content']); ?></textarea></div><div class="layui-form-item block"><span class="label-required-prev color-green">法文公告内容</span><textarea name="fr_content"><?php echo htmlentities($info['fr_content']); ?></textarea></div><div class="layui-form-item block"><span class="label-required-prev color-green">西班牙公告内容</span><textarea name="es_content"><?php echo htmlentities($info['es_content']); ?></textarea></div><div class="layui-form-item block"><span class="label-required-prev color-green">葡萄牙公告内容</span><textarea name="pt_content"><?php echo htmlentities($info['pt_content']); ?></textarea></div><div class="layui-form-item text-center"><button class="layui-btn" type="submit">确认编辑</button><button class="layui-btn layui-btn-danger" ng-click="hsitoryBack()" type="button">取消编辑</button></div></div></form></div><script>
    window.form.render();
