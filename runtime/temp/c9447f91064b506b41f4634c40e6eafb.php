<?php /*a:1:{s:75:"/www/wwwroot/194.233.81.202/application/index/view/my/edit_address-red.html";i:1657445902;}*/ ?>
<!DOCTYPE html><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo lang('收货地址修改'); ?></title><link href="/static_new6/css/app.red.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><style type="text/css" title="fading circle style">
        ...
        .test{
            ...
            margin-top: .666667rem;
                    ...
                    alt="" class="return"></div><div class="Maintitle"><h3><?php echo lang('收货地址编辑'); ?></h3></div><div class="right_btn"></div></div><div data-v-8831f782="" class="bink_card"><h3 data-v-8831f782=""><?php echo lang('收货身份信息'); ?></h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo lang('真实姓名'); ?></h4><input data-v-8831f782="" type="text" name="shoujianren" value="<?php echo htmlentities($info['name']); ?>" placeholder="<?php echo lang('未输入真实姓名,请设置'); ?>"></li><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo lang('电话号码'); ?></h4><input data-v-8831f782="" type="text" name="shouhuohaoma" value="<?php echo htmlentities($info['tel']); ?>" placeholder="<?php echo lang('未输入电话号码,请设置'); ?>"></li></ul><h3 data-v-8831f782=""><?php echo lang('收货地址信息'); ?></h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo lang('地区'); ?></h4><input data-v-8831f782="" type="text" name="area" autocomplete="off" value="<?php echo htmlentities($info['area']); ?>" placeholder="<?php echo lang('未输入地区，请设置'); ?>"></li><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo lang('详细地址'); ?></h4><input data-v-8831f782="" name="address" autocomplete="off" value="<?php echo htmlentities($info['address']); ?>" type="text" placeholder="<?php echo lang('未输入详细地址，请设置'); ?>"></li></ul><h3 data-v-8831f782="">&nbsp;</h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782=""><?php echo lang('设为常用地址'); ?></h4><label data-v-8831f782="" class="mint-switch"><input type="checkbox" class="mint-switch-input" checked readonly disabled><span class="mint-switch-core"></span><div class="mint-switch-label"></div></label></li></ul></div><p data-v-8831f782="" class="save-btn test"><?php echo lang('确定'); ?></p></div></form></div><script type="application/javascript">
    $(function () {
        /*点击登录*/
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.code == 0) {
                            ...
                            setTimeout(function () {
                                window.location.href="/index/rot_order/index";
                            }, 2000);
                        } else {
                            loading.close();
